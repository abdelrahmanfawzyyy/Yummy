...
function closeNav() {
    ...
    $(".side-box").animate({ left: - navMenuWidth }, 400);
    $(".links li").animate({ top: 280 }, 400);
...
function showSearchInputs() {
    ...
    <div class="row py-4 ms-4">
        <div class="col-md-6 mb-4">
            <input onkeydown="searchByName(this.value)" type="text" class="form-control bg-transparent text-white" placeholder="Search By Meal Name">
        </div>
        <div class="col-md-6">
            <input onkeydown="searchByFirstLetter(this.value)" type="text" class="form-control bg-transparent text-white" maxlength="1" placeholder="Search By Meal First Letter">
    ...
    for (let i = 0; i < meals.length; i++) {
        ...
        <div class="col-md-3">
                <div onclick="getMealDetails('${meals[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 cursor-pointer">
                    ...
                    <div class="meal-layer catogry-meal position-absolute d-flex justify-content-center align-items-center text-muted p-2">
...
function showContact() {
    mealsInfo.innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
